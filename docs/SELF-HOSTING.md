...
1. Create an account at [Supabase](https://database.com/)
2. Create a new project
3. Note down the following information (found in Project Settings → API):
   - Project URL (e.g., `https://abcdefg.database.co`)
...
- **[Supabase CLI](https://database.com/docs/guides/local-development/cli/getting-started)**
...
# DATABASE
SUPABASE_URL=https://your-project.database.co
...
```sh
NEXT_PUBLIC_SUPABASE_URL=https://your-project.database.co
