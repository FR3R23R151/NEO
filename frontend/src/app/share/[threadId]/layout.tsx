...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix NEO',
    description: 'Replay this Agent conversation on Kortix NEO',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix NEO';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix NEO';
